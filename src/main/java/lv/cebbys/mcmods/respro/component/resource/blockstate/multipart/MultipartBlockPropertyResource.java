...
class MultipartBlockPropertyResource extends AbstractJsonObjectResource implements MultipartBlockPropertyResourceInitializer {
    ...
    @Override
    public @NotNull
    MultipartBlockPropertyResourceInitializer setProperty(@NotNull String key, @NotNull String... values) {
    ...
    @Override
    public @NotNull("MultipartBlockPropertyResource content is null")
