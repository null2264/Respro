...
interface VariantBlockPropertyResourceInitializer
{
    ...
    @NotNull
    VariantBlockPropertyResourceInitializer setProperty(@NotNull String id, @NotNull String value);

    default @NotNull
    VariantBlockPropertyResourceInitializer setProperty(@NotNull String id, int value) {
        return setProperty(id, String.valueOf(value));
    }

    default @NotNull
    VariantBlockPropertyResourceInitializer setProperty(@NotNull String id, boolean value) {
        return setProperty(id, String.valueOf(value));
    }
